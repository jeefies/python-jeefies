...
class Connect:
    ...
    def __init__(self, imap=None, email=None, port=None):
        """
    ...
    def client(self, imap=None, ssl=True, **kwargs):
        ...
        try:
            ...
            self.client = IMAPClient(*imap, ssl=ssl, **kwargs)
            return self.client
    ...
    def fetch(self, uid, types=["BODY[]"]):
        ...
        return self.client.fetch(uid, types)
...
class Parse:
    ...
    def dict(self):
        ...
        s = {}
        for attr in ['From', 'To', 'Cc', 'Subject', 'get_con']:
    ...
    def get_param(self, msg=None):
        ...
        if msg.is_multipart():
            ...
            if name:
                s.append(File(name, msg.get_payload(decode=1)))
            return s
